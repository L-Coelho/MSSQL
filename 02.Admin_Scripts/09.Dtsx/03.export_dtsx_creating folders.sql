...
SELECT 
	...
	'mkdir '+ char(34) + 'd:\ssis' + F.FolderPath + char (34) +char (13) + char (10) +
    'dtutil /sourceserver ' + @@SERVERNAME + ' /SQL "'+ F.FolderPath + '\' + P.PackageName + '" /copy file;"'+ 'd:\ssis' + F.FolderPath +'\' + P.PackageName +'.dtsx"' AS cmd
FROM 
    FOLDERS F
    INNER JOIN
        PACKAGES P
